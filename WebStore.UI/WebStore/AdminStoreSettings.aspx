			...
			<portal:OuterBodyPanel ID="pnlOuterBody" runat="server">
				<portal:InnerBodyPanel ID="pnlInnerBody" runat="server" CssClass="modulecontent">
					<div id="divtabs" class="mojo-tabs">
						<ul>
							<li class="selected"><a href="#tab1"><em>
								<asp:Literal ID="litSettingsTab" runat="server" /></em></a></li>
							<li><a href="#tab2"><em>
								<asp:Literal ID="litDescriptionTab" runat="server" /></em></a></li>
							<li><a href="#tab3"><em>
								<asp:Literal ID="litClosedTab" runat="server" /></em></a></li>
						</ul>

						<div id="tab1">
							<div class="settingrow">
								<mp:SiteLabel ID="lblName" runat="server" CssClass="settinglabel" ConfigKey="StoreNameLabel" ResourceFile="WebStoreResources" />
								<asp:TextBox ID="txtName" runat="server" MaxLength="255" CssClass="verywidetextbox forminput" />
							</div>
							<div class="settingrow">
								<mp:SiteLabel ID="lblOwnerName" runat="server" CssClass="settinglabel" ConfigKey="StoreOwnerNameLabel" ResourceFile="WebStoreResources" />
								<asp:TextBox ID="txtOwnerName" runat="server" MaxLength="255" CssClass="verywidetextbox forminput" />
							</div>
							<div class="settingrow">
								<mp:SiteLabel ID="lblOwnerEmail" runat="server" CssClass="settinglabel" ConfigKey="StoreOwnerEmailLabel" ResourceFile="WebStoreResources" />
								<asp:TextBox ID="txtOwnerEmail" runat="server" MaxLength="100" CssClass="verywidetextbox forminput" />
							</div>
							<div class="settingrow">
								<mp:SiteLabel ID="lblCountryGuid" runat="server" CssClass="settinglabel" ConfigKey="StoreCountryLabel" ResourceFile="WebStoreResources" />
								<asp:DropDownList ID="ddCountryGuid" runat="server" DataTextField="Name" DataValueField="Guid" AutoPostBack="true" />
							</div>
							<div class="settingrow">
								<mp:SiteLabel ID="lblAddress" runat="server" CssClass="settinglabel" ConfigKey="StoreAddressLabel" ResourceFile="WebStoreResources" />
								<asp:TextBox ID="txtAddress" runat="server" MaxLength="255" CssClass="verywidetextbox forminput" />
							</div>
							<div class="settingrow">
								<mp:SiteLabel ID="lblCity" runat="server" CssClass="settinglabel" ConfigKey="StoreCityLabel" ResourceFile="WebStoreResources" />
								<asp:TextBox ID="txtCity" runat="server" MaxLength="255" CssClass="verywidetextbox forminput" />
							</div>
							<div class="settingrow">
								<mp:SiteLabel ID="lblZoneGuid" runat="server" CssClass="settinglabel" ConfigKey="StoreZoneLabel" ResourceFile="WebStoreResources" />
								<asp:DropDownList ID="ddZoneGuid" runat="server" DataTextField="Name" DataValueField="Guid" />
							</div>
							<div class="settingrow">
