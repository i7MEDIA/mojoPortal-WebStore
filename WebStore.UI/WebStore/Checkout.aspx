			...
			<portal:OuterBodyPanel ID="pnlOuterBody" runat="server">
				<portal:InnerBodyPanel ID="pnlInnerBody" runat="server" CssClass="modulecontent checkoutbody">
						...
						<fieldset id="frmCardInput" runat="server" class="clear">
							...
							<div class="settingrow">
								<mp:SiteLabel runat="server"
									ID="lblCardSecurityCode"
									CssClass="settinglabel"
									ConfigKey="CartOrderInfoCardSecurityCodeLabel"
									ResourceFile="WebStoreResources" />
								<asp:TextBox runat="server"
									ID="txtCardSecurityCode"
									MaxLength="50"
									CssClass="forminput smalltextbox" />
							</div>
					...
					<div class="settingrow">
						...
						<br />
						<portal:mojoLabel ID="lblGoogleMessage" runat="server" CssClass="txterror warning" Visible="false"></portal:mojoLabel>
					</div>
