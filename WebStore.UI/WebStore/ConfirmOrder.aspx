			...
			<portal:OuterBodyPanel ID="pnlOuterBody" runat="server">
				<portal:InnerBodyPanel ID="pnlInnerBody" runat="server" CssClass="modulecontent">
					...
					<asp:Panel ID="pnlOrderDetail" runat="server" CssClass="clear orderdetail" Visible="false">
						<asp:Panel ID="pnlCustomer" runat="server" CssClass="floatpanel" DefaultButton="btnSaveAndValidate">
							<fieldset>
								...
								<div class="settingrow">
									...
									<asp:RequiredFieldValidator ID="reqCustomerEmail" runat="server" ControlToValidate="txtCustomerEmail" ValidationGroup="OrderInfo" SetFocusOnError="true" />
									<portal:EmailValidator ID="regexCustomerEmail" runat="server" ControlToValidate="txtCustomerEmail" ValidationGroup="OrderInfo" SetFocusOnError="true" />
								</div>
							</fieldset>
						</asp:Panel>
						...
						<div class="settingrow">
							&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
							<asp:Literal runat="server" ID="litOr" />
						</div>
					</asp:Panel>

					<div class="settingrow">
						&nbsp;&nbsp;&nbsp;&nbsp;
						<asp:ImageButton ID="btnPayPal" runat="server" ImageUrl="https://www.paypal.com/en_US/i/btn/btn_xpressCheckout.gif" AlternateText="Checkout with PayPal" />
