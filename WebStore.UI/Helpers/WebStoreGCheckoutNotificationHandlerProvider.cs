...
{
	/// <summary>
	/// This is only here because some people have probably not deleted the provider config for it from setup/providers
	/// Google Checkout was discontinued 11/20/2013
	/// </summary>
	[Obsolete("Google Checkout was discontinued 11/20/2010")]
    public class WebStoreGCheckoutNotificationHandlerProvider : OrderCompletedHandlerProvider
	{
